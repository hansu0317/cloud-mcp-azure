...
// 프로젝트 목록 — v1(2026-08-25): 전부 개인 프로젝트, 로그인한 사람은 본인 것만
// 본다(data/users/<이메일>/projects/). 테이블 스코프는 목록에 항상 펼쳐 두지 않고,
// Databricks Genie의 "Connect your data" 팝업처럼 별도 모달에서 고른다. 새
// 프로젝트를 만들면 곧바로 그 모달이 뜨고, 이후에는 각 행의 "＋ 테이블" 버튼으로
// 언제든 다시 열어 추가/해제한다.
